...
public class RegexEaxmples {
	...
	public static void main(String[] args) {
		...
		System.out.println(Pattern.matches("[a-z]{2,6}", "john")); //true
		System.out.println(Pattern.matches("[a-z]{2,6}", "johmsmith")); //false
		System.out.println(Pattern.matches("[a-z]{2,6}", "johSmi")); //false
